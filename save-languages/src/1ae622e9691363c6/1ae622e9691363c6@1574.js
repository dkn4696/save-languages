...
FileAttachment("data4.json").json()
)}
...
Object.entries(data1).map(d=>{
  ...
  return {country:d[1].Country,
         ...
         // deaths_per_million:countryArrayIndex !== -0 ? d[1].total_deaths_per_million : NaN,
          population:countryArrayIndex !== -0 ? d[1].Population : NaN,
          position: countryArrayIndex !== arrpos  ? path.centroid(world.features[countryArrayIndex]) : [d[1].Longitude, d[1].Latitude], //[0,0],
          cluster:d[1].Degree}
})
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ...
    ["data4.json", {url: new URL("./files/7590cf0d2a48c357259360fd88b632c744201e8d2637594c4587cdc51113d9c630e73870cf6df0c8e80c739bac72b5e4a0808da84f1b1f77bcb4c8eac63e03d9.json", import.meta.url), mimeType: "application/json", toString}]
  ]);
